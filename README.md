## ros_web_video (indigo) - 0.1.13-0

The packages in the `ros_web_video` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo ros_web_video --new-track` on `Wed, 08 Oct 2014 17:44:06 -0000`
...
## ros_web_video (hydro) - 0.1.13-0

The packages in the `ros_web_video` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro ros_web_video --new-track` on `Wed, 08 Oct 2014 17:42:13 -0000`
